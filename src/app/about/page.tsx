  ...
  return (
    <div style={{ padding: '140px 0 6rem', minHeight: '100vh', background: 'var(--midnight)' }}>
      <div className="container" style={{ maxWidth: '900px' }}>
        ...
        <h1 className="heading-xl" style={{ color: '#F0E8D5', margin: '1rem 0 1.25rem' }}>South Africa&apos;s Premium Home Solutions Platform</h1>
        <p style={{ color: '#9A9080', fontSize: '1.02rem', lineHeight: 1.8, marginBottom: '2rem' }}>
        ...
        <div style={{ display: 'grid', gap: '1rem', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', marginBottom: '2rem' }}>
          {[
            ...
            <article key={item.title} style={{ background: '#1A1714', border: '1px solid rgba(201,168,76,0.18)', borderRadius: 14, padding: '1.1rem' }}>
              <h2 className="heading-md" style={{ color: '#F0E8D5', fontSize: '1.2rem', marginBottom: '0.4rem' }}>{item.title}</h2>
              <p style={{ color: '#9A9080', fontSize: '0.95rem' }}>{item.text}</p>
            </article>
          ))}
        </div>

        <div style={{ background: '#1A1714', border: '1px solid rgba(201,168,76,0.2)', borderRadius: 14, padding: '1.25rem' }}>
          <h3 className="heading-md" style={{ color: '#F0E8D5', marginBottom: '0.5rem' }}>Our Promise</h3>
          <p style={{ color: '#9A9080', lineHeight: 1.8 }}>
